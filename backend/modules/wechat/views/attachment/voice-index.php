...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row separateFromNextBlock">
        <div class="col-sm-12">
            ...
            <div class="ibox-tools">
                <a class="btn btn-primary btn-xs" id="getAllAttachment">
                    <i class="fa fa-cloud-download"></i>  同步语音
                </a>
                <a class="btn btn-primary btn-xs" href="<?php echo Url::to(['voice-add','model'=>'perm'])?>"  data-toggle='modal' data-target='#ajaxModal'>
                    <i class="fa fa-plus"></i>  创建语音
                </a>
            </div>
        </div>
      ...
      <div class="col-sm-12">
         <div class="btn-group">
                 <?php foreach ($StatusType as $key => $mo){ ?>
                    <a class="btn <?php echo $status == $key ? 'btn-primary': 'btn-white' ;?>" href="<?= Url::to([$mediaType.'-index','status'=>$key])?>"><?= $mo ?></a>
                <?php } ?>
            </div>
    </div>
    <div class="row">
                        ...
                        <div class="borderColorGray separateChildrenWithLine whiteBG" style="margin-bottom: 30px;">
                            <div class="normalPadding">
                                <div style="height: 160px;text-align:center;" class="backgroundCover relativePosition mainPostCover">
                                    <i class="fa fa-volume-up" style="font-size: 50px;margin:0 auto;padding-top: 30px"></i>
