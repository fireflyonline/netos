<?php
use wayfiretech\netos\common\models\wechat\RuleKeyword;
?>
<div class="col-sm-12">
    <div class="panel panel-default">
        ...
        <div id="collapseOne" class="panel-collapse collapse in" aria-expanded="true" style="">
            <div class="panel-body">
                <div class="col-sm-12">
                    <div class="col-sm-9">
                        <?= $form->field($rule, 'name')->textInput()->hint('您可以给这条规则起一个名字, 方便下次修改和查看。') ?>
                        <div class="advanced" style="display: none">
                            <?= $form->field($rule, 'displayorder')->textInput()->hint('规则优先级，越大则越靠前，最大不得超过255') ?>
                        </div>
                    </div>
                ...
                <div class="col-sm-12">
                    <div class="col-sm-9">
                        <?= $form->field($keyword, 'content')->textInput(['value'=> implode(',',$ruleKeywords[RuleKeyword::TYPE_MATCH])])->hint('多个关键字请使用逗号隔开，如天气，今日天气。') ?>
                        <div class="advanced" style="display: none">
                ...
                <div class="col-sm-12">
                    <div class="col-sm-9">
                        <?= $form->field($rule, 'status')->radioList(['1'=>'启用','-1'=>'禁用'])->hint('您可以临时禁用这条回复') ?>
                    </div>
                </div>
            </div>
        </div>
...
<script id="keytask" type="text/html">
    <tr>
        <td>
            <span class="key-text">符合优先级条件时, 这条回复将直接生效</span>
            <input type="hidden" name="ruleKey[{{type}}][]" value="">
        </td>
        <td>
            <span class="btn btn-white" onclick="$(this).parent().parent().remove()">取消接管</span>
        </td>
