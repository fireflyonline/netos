...
class CurdController extends \backend\controllers\MController
{
    ...
    public function actions()
    {
        return [
            'index' => [
                'class' => 'wayfiretech\netos\backend\actions\IndexAction',
            ...
            'edit' => [
                'class' => 'wayfiretech\netos\backend\actions\EditAction',
                'modelClass' => $this->modelClass,
                'columns' => $this->editColumns,
            ],
            'ajax-update' => [
                'class' => 'wayfiretech\netos\backend\actions\AjaxUpdateAction',
                'modelClass' => $this->modelClass,
            ],
            'delete' => [
                'class' => 'wayfiretech\netos\backend\actions\DeleteAction',
                'modelClass' => $this->modelClass,
            ],
        ];
    }
