<?php
namespace wayfiretech\netos\common\controllers;

use yii;
use yii\web\BadRequestHttpException;
use common\models\Ceshi;
...
class WechatController extends \common\controllers\BaseController
{
    ...
    public function init()
    {
        ...
        Yii::error("error,授权错误日志");
        //公众号类别
        //1:普通订阅号   2:普通服务号   3:认证订阅号   4:认证服务号/认证媒体/政府订阅号
        $WECHAT_RANK = Yii::$app->config->info('WECHAT_RANK');
        if ($WECHAT_RANK>=3) {
           /** 检测到微信进入自动获取用户信息 **/
        ...
        Ceshi::add(json_encode($this->_wechatMember));
    }
